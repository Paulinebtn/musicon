...
<body class="melomane">
    ...
    <main>
        ...
        <!-- SECTION BANDES SONS COLLABORATIVES -->
        ...
        <section class="playlist">
	        <div class="ligne-artiste">
                <h2>Toutes mes playlists</h2>
                 <a href="#"><button class="music-space button">Ajouter une playlist</button></a>
                <div class="artists">
                    <div>
                        <figure class="anim-img">
							<img src="img/musician6.png" alt="sample87"/>
							<figcaption>
								...
								<div class="content-anim">
									<div>
										<div class="name-mus">Nom Playlist</div>
